...
Starting today, recreational weed is legal in Canada.  This news has some how lead me to find  [Cannibus Curve](http://mathworld.wolfram.com/CannabisCurve.html), a mathmatical equation to draw Cannibus....!!! 

So to celebrate? being 2nd country in the world (1st was [Uruguay](http://fortune.com/2018/10/17/canada-marijuana-weed-legalization-uruguay/)) to legalize the green stuff for fun, I decided I'll try drawing cannibus curve with ggplot. Here's the final results. 

![Cannibus_Final](/post/2018-10-17-cannibus-curve-with-ggplot2_files/cannibus.png){width=600px}
...
```{r demystify_cannibus, echo=TRUE, fig.width=8, message=FALSE, warning=FALSE, paged.print=FALSE}
